\begin{textsample}{POS Dim 8 – global\_north\_2024\_12 – Score 13.00 – global\_north\_2024\_12/118981972.txt}  \label{ex:f8_pos_094}
...
New \textbf{MEE} \textbf{newsletter} : Jerusalem Dispatch Sign up to get the latest \textbf{insights} and analysis on Israel-Palestine, alongside Turkey \textbf{Unpacked} and other \textbf{MEE} \textbf{newsletters} Near-total destruction Kamal Adwan Hospital, one of only three partially functioning facilities in the area, has faced relentless attacks, including drone strikes, ground invasions, and bombings.
...
% matched lemmas: associate, coverage, displacement, fee, fill, insight, mee, necessarily, newsletter, please, republish, unpack, unrivalled
\end{textsample}
