\begin{textsample}{POS Dim 8 – global\_north\_2024\_12 – Score 13.00 – global\_north\_2024\_12/118379632.txt}  \label{ex:f8_pos_098}
New \textbf{MEE} \textbf{newsletter} : Jerusalem Dispatch Sign up to get the latest \textbf{insights} and analysis on Israel-Palestine, alongside Turkey \textbf{Unpacked} and other \textbf{MEE} \textbf{newsletters} Mayors from northern towns flooded the media with threats to protest the decision.
...
Meanwhile, the new elites, Finance Minister Bezalel Smotrich and National Security Minister Itamar Ben Gvir, are more interested in \textbf{resettling} Gaza.
...
% matched lemmas: associate, coverage, fee, fill, insight, mee, necessarily, newsletter, please, republish, resettle, unpack, unrivalled
\end{textsample}
