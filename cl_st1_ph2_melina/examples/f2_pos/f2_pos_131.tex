\begin{textsample}{POS Dim 2 – global\_south\_2024\_10 – Score 32.00 – global\_south\_2024\_10/116710388.txt}  \label{ex:f2_pos_131}
The prolonged conflict has also overwhelmed local \textbf{emergency} \textbf{responders}, who are struggling to meet the urgent needs of the \textbf{civilian} \textbf{population}.
A Palestinian man walks past the rubble after Israeli forces withdrew from the \textbf{area} around Kamal Adwan \textbf{hospital}, amid the ongoing Israel-Hamas conflict, in Jabalia, in the \textbf{northern} Gaza Strip October 26, 2024. ( REUTERS Photo ) On Monday, Israeli \textbf{tanks} launched a significant \textbf{incursion} into \textbf{northern} Gaza, penetrating two \textbf{towns} and a historic \textbf{refugee} \textbf{camp}, which resulted in approximately 100,000 \textbf{civilians} being trapped, according to reports from the Palestinian \textbf{emergency} service.
This military action is part of a broader Israeli \textbf{operation} aimed at dismantling regrouping Hamas militants in the region, further escalating the already dire \textbf{humanitarian} situation in Gaza.
...
This contradiction underscores the complexities and contentious narratives surrounding the conflict @ @ @ @ @ @ @ @ @ @ at least 19 individuals were killed due to Israeli airstrikes and \textbf{bombardment} on Monday alone, with 13 of these casualties occurring in the \textbf{northern} parts of the territory.
...
The prolonged conflict has overwhelmed local \textbf{emergency} \textbf{responders}, who are struggling to meet the urgent needs of the \textbf{civilian} \textbf{population}.
...
Iran ' s Foreign Ministry responded by declaring that Tehran would"use @ @ @ @ @ @ @ @ @ @ actions.
...
In a tragic reflection of the situation, the Gaza \textbf{health} ministry reported that in the past week, at least one doctor, a nurse, and two \textbf{child} \textbf{patients} have died in \textbf{hospitals} due to a lack of \textbf{medical} treatment.
...
% matched lemmas: area, besiege, bombardment, camp, child, city, civilian, emergency, facility, food, fuel, health, healthcare, hospital, humanitarian, incursion, intensified, medical, northern, offensive, operation, patient, population, refugee, responder, severe, shelter, shortage, southern, supply, tank, town, worker
\end{textsample}
