\begin{textsample}{NEG Dim 8 – global\_north\_2024\_04 – Score -1.00 – global\_north\_2024\_04/200395587.txt}  \label{ex:f8_neg_137}
...
There are at least 10 Iron Dome batteries in Israel, each equipped with a radar that detects rockets and then uses a \textbf{command-and-control} system that quickly calculates whether an incoming projectile poses a threat or is likely to hit an unpopulated area.
