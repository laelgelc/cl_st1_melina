\begin{textsample}{POS Dim 7 – global\_south\_2024\_02 – Score 6.00 – global\_south\_2024\_02/106228977.txt}  \label{ex:f7_pos_200}
...
Some \textbf{voters} in Joe Biden ' s \textbf{Democratic} Party are attempting to press the president on the issue, with groups of Arab American \textbf{voters} in Michigan pledging to \textbf{vote}"\textbf{uncommitted}"or write in"Free Palestine"on their \textbf{ballots} in the state ' s \textbf{primary} on Tuesday.
...
% matched lemmas: ballot, democratic, primary, uncommitted, vote, voter
\end{textsample}
