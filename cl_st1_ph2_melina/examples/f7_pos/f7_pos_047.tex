\begin{textsample}{POS Dim 7 – global\_north\_2024\_07 – Score 12.00 – global\_north\_2024\_07/111183590.txt}  \label{ex:f7_pos_047}
...
On Wednesday, \textbf{Vice} President Kamala Harris was not in that \textbf{seat} during Netanyahu ' s address.
...
As House Speaker Mike Johnson put it,"It ' s outrageous to me and inexcusable that Kamala Harris is \textbf{boycotting} this joint session."Johnson, a \textbf{Republican}, was the lawmaker who invited Netanyahu, in part to accentuate the differences between Republicans and Democrats on Israel in an \textbf{election} year.
He knew many \textbf{Democrats} would \textbf{boycott} the speech.
Yet, the \textbf{Democratic} leadership signed off on the \textbf{invitation}, and as such, Harris should have shown up.
This would have been an opportunity to turn the tables on Johnson and demonstrate that there is no difference between the two parties when it comes to fundamental support for the Jewish state.
...
To pander to the progressives of her party upset with the administration ' s overall strong support for Israel during the current war.
She needs to be savvy enough politically, however, to realize that as she is pandering to one flank of her party, she risks alienating pro-Israel \textbf{voters} on the other side.
...
Those"problematic"comments -- including accusations that Gazans were starving because of Israel and that anti-Israel protesters on campus were"showing exactly what the human emotion should be"-- raise @ @ @ @ @ @ @ @ @ @ : with Israel or the anti-Israel elements within the progressive wing of her party.
...
% matched lemmas: boycott, candidate, democrat, democratic, election, invitation, nominee, presidential, republican, seat, vice, voter
\end{textsample}
