\begin{textsample}{POS Dim 5 – global\_south\_2025\_06 – Score 19.00 – global\_south\_2025\_06/126035709.txt}  \label{ex:f5_pos_041}
...
It further isolates institutions like the UN, \textbf{International} Criminal \textbf{Court} ( ICC ) and \textbf{International} \textbf{Court} of Justice ( ICJ ), which have found themselves increasingly sidelined as Israel ' s assault on Gaza has progressed.
...
At the same time, the Trump administration is actively undermining the global institutions designed to \textbf{enforce} \textbf{international} \textbf{law}.
...
The \textbf{court} went further in July, issuing a landmark \textbf{advisory} opinion declaring Israel ' s occupation of Palestinian territory illegal.
...
Disregarding \textbf{international} \textbf{law} These dramatic attempts to \textbf{enforce} \textbf{international} \textbf{law} failed.
...
Aid is conditional on population displacement, @ @ @ @ @ @ @ @ @ @.
This approach, which has been condemned by humanitarian organisations, contravenes established humanitarian principles of \textbf{neutrality} and impartiality.
In effect, one pillar of the post-war order is attacking another.
The leading founder of the UN is now undermining the institution from within, wielding its security council \textbf{veto} to block action while simultaneously starving the organisation of resources.
The US \textbf{vetoed} a UN security council \textbf{resolution} calling for a ceasefire in Gaza on June 4.
...
It is employing grey-zone tactics, that do everything possible in provocation and disinformation below the threshold of open warfare, undeterred by \textbf{legal} commitments to peaceful \textbf{resolution}.
These \textbf{cases} are symptoms of @ @ @ @ @ @ @ @ @ @.
Israel ' s policy in Gaza and its attack on Iran are not exceptions but the acceleration.
They are confirmation to other states that \textbf{law} no longer constrains power, institutions can be bypassed, and humanitarian principles can be used for political ends.

% matched lemmas: act, advisory, case, court, crime, enforce, genocide, international, law, legal, measure, mechanism, neutrality, provisional, resolution, ruling, sanction, veto, warrant
\end{textsample}
