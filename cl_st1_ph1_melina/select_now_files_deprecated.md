# `select_now_files_deprecated.py` Programme

Write a Python programme named `select_now_files_deprecated.py` that processes a dataset directory and writes filtered outputs to another directory.
