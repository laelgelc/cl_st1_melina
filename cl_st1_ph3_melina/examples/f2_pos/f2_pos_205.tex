\begin{textsample}{POS Dim 2 – global\_south\_2024\_12 – Score 21.00 – global\_south\_2024\_12/119372145.txt}  \label{ex:f2_pos_205}
Houthis \textbf{vow} to continue \textbf{attacking} Israel despite \textbf{strikes} on Yemen Yemen - A Houthi political official says the group will continue \textbf{attacking} Israel in solidarity with the Palestinians despite the \textbf{escalating} Israeli \textbf{air} \textbf{strikes} in Yemen.
...
On Thursday, Israeli warplanes \textbf{struck} the international airport in Yemen ' s \textbf{capital}, Sanaa, and ports and power stations on the Red Sea coast, killing at least four people.
Israel ' s Prime Minister Benjamin Netanyahu warned that its response to more than a year of \textbf{missile} and \textbf{drone} \textbf{attacks} by the \textbf{Iran-backed} group was"just getting started".
...
The Houthis, who control north-western Yemen, began \textbf{attacking} Israel and international shipping shortly after the start of the war between Israel and Hamas in Gaza in October 2023.
...
The US and UK have also carried out \textbf{air} \textbf{strikes} in Yemen in response to the group ' s \textbf{attacks} on dozens of merchant vessels in the southern Red Sea and the Gulf of Aden.
Mohammed al-Bukhaiti, a member of the Houthis ' political bureau, told the BBC ' s Newshour programme on Friday that \textbf{Yemenis} were now"moving to a direct confrontation"with the US, UK and Israel after fighting what he called their"tools"during Yemen ' s decade-long civil war.
...
He also said the Houthis expected an \textbf{escalation} by the US after President-elect Donald Trump took office next month, but he warned that it would"backfire".
Israel ' s prime minister said on Thursday evening that his country had"\textbf{attacked} \textbf{targets} of the Houthi terrorist organisation"as part of what he called a"war of redemption"."We are determined to cut off this terrorist arm of Iran ' s \textbf{axis} of evil.
...
% matched lemmas: air, ally, attack, axis, ballistic, capability, capital, drone, escalate, escalation, intercept, iran-backed, launch, missile, region, restraint, retaliation, strike, target, vow, yemeni
\end{textsample}
