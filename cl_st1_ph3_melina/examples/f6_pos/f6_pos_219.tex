\begin{textsample}{POS Dim 6 – global\_south\_2024\_05 – Score 3.00 – global\_south\_2024\_05/108579878.txt}  \label{ex:f6_pos_219}
US Gaza pier knocked out of action by heavy \textbf{seas} A temporary pier built by the US military to deliver aid to Gaza has been damaged by heavy \textbf{seas} and will take at least a week to be repaired, according to US officials.
...
Ms Singh said weather conditions in the area had not created an"optimal environment"for the pier ' s deployment, but that defence officials remain confident it would be operational again soon."I can't predict the weather,"she said."But we believe that given the time of year, we will be able to re-anchor this pier."Mick Mulroy, a former deputy assistant secretary of defence for the Middle East and one of the founders of Fogbow, a private firm involved in the Gaza pier plan, @ @ @ @ @ @ @ @ @ @ to"pose challenges"."But those challenges can be overcome, and the mission itself is worth the effort,"he said."People are in desperate need of aid and this is one means to deliver it."On 17 May, the US military confirmed that the first \textbf{shipments} of humanitarian aid were delivered into Gaza via the pier, but in a separate incident last weekend four \textbf{vessels} supporting the pier became unmoored in"heavy \textbf{sea} states", beaching two of them.
...
% matched lemmas: sea, shipment, vessel
\end{textsample}
