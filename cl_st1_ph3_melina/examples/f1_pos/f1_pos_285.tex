\begin{textsample}{POS Dim 1 – global\_south\_2025\_04 – Score 29.00 – global\_south\_2025\_04/123047698.txt}  \label{ex:f1_pos_285}
Israel orders mass evacuation in Rafah amid renewed Gaza \textbf{offensive} \textbf{Displaced} Palestinians, who \textbf{flee} from Rafah, arrive in Khan Younis, Gaza, on Monday, March 31, 2025, after the Israeli military issued sweeping evacuation orders covering most of Rafah AP Israel issued sweeping evacuation orders in Rafah, Gaza ' s \textbf{southernmost} \textbf{city}, on March 31, prompting tens of thousands of Palestinians to \textbf{flee} at a time when Muslims were celebrating Eid ul-Fitr, marking the end of the holy month of \textbf{Ramadan}.
The orders, affecting at least 1.4 lakh people according to Philippe Lazzarini of the UN agency for Palestinian \textbf{refugees} ( UNRWA ), hinted at an impending major \textbf{ground} \textbf{operation}.
...
The latest evacuation orders followed \textbf{intensified} Israeli attacks in Rafah on March 29, with more \textbf{troops} deployed.
...
Israel seized the Rafah \textbf{crossing}, Gaza ' s only non-Israeli-controlled \textbf{external} link, and a border corridor to curb weapons smuggling.
...
Earlier last month, Israel ended a two-month truce with Hamas, resuming air and \textbf{ground} attacks.
...
Israel has proposed a new ceasefire via mediators in Egypt and Qatar, demanding Hamas release 11 living hostages and 16 bodies in exchange for an unspecified number of Palestinian prisoners. \textbf{Fighting} would pause for 40 days after the hostages ' release, with further talks planned.
...
The Palestinian presidency called them a violation of international law, warning of dire consequences and holding Israel accountable for rising @ @ @ @ @ @ @ @ @ @ terms, holding Israel responsible for not providing proper conditions such as hygiene, \textbf{health} and safety for the \textbf{displaced}.
...
Last week, 14 \textbf{aid} \textbf{workers} ' bodies -- eight from the Palestine Red Crescent Society ( PRCS ), five from civil defence and one from a UN agency -- were found in a Rafah mass grave after Israeli attacks.
...
% matched lemmas: aid, ambulance, area, camp, child, city, civilian, crossing, displace, external, fighting, flee, ground, health, humanitarian, infrastructure, intensified, medic, neighbourhood, northern, offensive, operation, ramadan, refugee, southern, southernmost, tent, troop, worker
\end{textsample}
