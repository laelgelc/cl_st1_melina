...
def main():
    ...
    INPUT_BASE = Path("corpus/04_now_screened_iqr")
    ...
    # Gather group folders under corpus/04_now_screened_iqr/
    ...
    # Collect files from corpus/04_now_screened_iqr/<group>/<country_code>/
