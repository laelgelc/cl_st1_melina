/* ============================================================
   ...
   Expected counts.txt format:
     ...
     Space-separated
     Columns:
       filename group v000001-v001012

   Example:
     t000001 global_north_2023_09 0 1 0 0 ...
   ============================================================ */
...
data scores_only (KEEP= filename group group &factorvars );
set scores_grouped ;
run;

/* fix variable order */
data scores_only;
 retain filename group group &factorvars;
 set scores_grouped;
run;
...
cards4;
/home/u63529080/cl_st1_ph3_melina
;;;;
run;
